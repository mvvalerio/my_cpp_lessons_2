...
struct produto {
    ...
    float preco;
    int quantidade;
    char estado;    // MUDADO ( Ativo = A; Apagado = D; O = out of stock)
};
...
void lerprod(produto Produtos[], int quantidadeatual, const string& nomearquivo){ 

    ifstream nomearquivo("Produtos.txt");
